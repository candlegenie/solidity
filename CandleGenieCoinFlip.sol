...
contract CandleGenieCoinFlip is Ownable, Pausable, ReentrancyGuard 
{
    ...
    function _safeEndRound(uint256 epoch) internal 
    {
        ...
        uint256 flipResult = generateRandomNumber();
        Position roundPosition = flipResult < 500 ? Position.Heads : Position.Tails;
        
        round.position = roundPosition;
        round.flipResult = flipResult;
        round.flipTimestamp = uint32(block.timestamp);
        round.closed = true;
